...
extern const bios_rom_string_t bios_rom_strings[];
extern const u16 bios_rom_string_count;
...
const char *bios_lookup_rom_string (u16 rom_offset);
...
u8 bios_default_pc1640_video_mode (void);
