...
def main() -> int:
    ...
    int10_wrapper_off = symbol_offset(args.nm, args.elf, "bios_int10_wrapper")
    rom[ROS_VIDEO_INT10_COMPAT_ROM_OFFSET:
        ROS_VIDEO_INT10_COMPAT_ROM_OFFSET + 5] = far_jump(BIOS_ROM_SEGMENT,
                                                          int10_wrapper_off)
